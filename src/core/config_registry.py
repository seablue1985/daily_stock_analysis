...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "MARKET_DATA_FETCHER_PRIORITY": {
        "title": "Market Data Fetcher Priority",
        "description": "Comma-separated priority for daily/history/research fetchers.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "ths,pytdx,tushare,efinance,akshare,baostock,yfinance",
        "options": [],
        "validation": {},
        "display_order": 21,
    },
